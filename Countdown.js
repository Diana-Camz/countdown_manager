...
/*function Clear(){
  console.log("clear");
  let createFunction = Create(deadline);
  IntervalCreated = countdown(createFunction, newDay, newHour, newMinute, newSecond);
  
  let clearCountdown = IntervalCreated.timerUpdate;
...
//countdown("Aug 30 2023 19:11:45", "ha-newDay", "ha-newHour", "ha-newMinute", "ha-newSecond");
